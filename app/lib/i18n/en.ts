...
export const en: Translations = {
  ...
  supportedFormats: "(.nmea / .gpx / .kml / .kmz / .ubx / .txt / .log)",
  clearButton: "Clear",
  ...
  // UBX
  exportToRinexObs: "⬇ Export RINEX OBS (.obs)",
  exportToRinexNav: "⬇ Export RINEX NAV (.nav)",
  ubxFixType: "Fix type",
  ubxHAcc: "H.Accuracy",
  ubxVAcc: "V.Accuracy",
  ubxPDOP: "PDOP",
  ...
  ubxHDOP: "HDOP",
  ubxAntenna: "Antenna",
  ubxMessageStats: "UBX message counts",
  ubxRawxEpochs: "RAWX epochs",
  ubxNavMessages: "NAV messages",
  ubxNoPpkData: "No RAWX data found. Enable RXM-RAWX and RXM-SFRBX in u-center for PPK.",
  ubxPpkExportTitle: "PPK / RINEX Export",
  ubxAccuracyChartTitle: "Accuracy estimate (m)",
  ubxDopChartTitle: "DOP values",
  ubxHAccTooltip: (v) => `H.Acc: ${v} m`,
  ubxVAccTooltip: (v) => `V.Acc: ${v} m`,
  ubxPDopTooltip: (v) => `PDOP: ${v}`,
  ubxHDopTooltip: (v) => `HDOP: ${v}`,
  satelliteUbxOnly: "Satellite data is only available for NMEA and UBX files.",
