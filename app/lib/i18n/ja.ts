...
export const ja: Translations = {
  ...
  // UBX
  exportToRinexObs: "⬇ RINEX OBS出力 (.obs)",
  exportToRinexNav: "⬇ RINEX NAV出力 (.nav)",
  ubxFixType: "フィックスタイプ",
  ubxHAcc: "水平精度",
  ubxVAcc: "垂直精度",
  ubxPDOP: "PDOP",
  ...
  ubxHDOP: "HDOP",
  ubxAntenna: "アンテナ",
  ubxMessageStats: "UBXメッセージ統計",
  ubxRawxEpochs: "RAWXエポック数",
  ubxNavMessages: "航法メッセージ数",
  ubxNoPpkData: "RAWXデータがありません。PPK処理にはu-centerでRXM-RAWXとRXM-SFRBXを有効にしてください。",
  ubxPpkExportTitle: "PPK / RINEX出力",
  ubxAccuracyChartTitle: "精度推定値 (m)",
  ubxDopChartTitle: "DOP値",
  ubxHAccTooltip: (v) => `水平精度: ${v} m`,
  ubxVAccTooltip: (v) => `垂直精度: ${v} m`,
  ubxPDopTooltip: (v) => `PDOP: ${v}`,
  ubxHDopTooltip: (v) => `HDOP: ${v}`,
  satelliteUbxOnly: "衛星データはNMEAおよびUBXファイルのみ表示できます。",
